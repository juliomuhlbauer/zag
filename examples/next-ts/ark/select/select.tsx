...
export interface SelectProps<T extends CollectionItem>
  extends Assign<
      Assign<HTMLArkProps<"div">, { children?: ReactNode | ((api: UseSelectReturn<T>) => ReactNode) }>,
      UseSelectProps<T>
    >,
    UsePresenceProps {}

const SelectImpl = <T extends CollectionItem>(props: SelectProps<T>, ref: React.Ref<HTMLDivElement>) => {
  const [presenceProps, selectProps] = splitPresenceProps(props)
  const [useSelectProps, { children, ...localProps }] = createSplitProps<UseSelectProps<T>>()(selectProps, [
    "closeOnSelect",
    "defaultValue",
    "dir",
    "disabled",
